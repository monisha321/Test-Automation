package com.sgteating.pageobjectmodel;
...
public class ActiTimePages {
	...
	private WebElement taskac;
	public WebElement taskaction()
	{
		return taskac;
	}
	...
	private WebElement taskd2;
	public WebElement taskdel()
	{
		return taskd2;
	}


	//task dlt permanently  
	@FindBy(xpath= "//*[@id='taskPanel_deleteConfirm_submitTitle']")
	private WebElement taskd1;
	public WebElement taskdelp()
	{
		return taskd1;
	}
}
